...
class AsyncNotifier:
    ...
    def notify_scalping_start(
        ...
        return self._enqueue_notification(
            "notify_scalping_start", achievement_pct, remaining_krw, dry_run
        )
    ...
    def notify_error_scalping(
        ...
        return self._enqueue_notification(
            "notify_error_scalping", message, achievement_pct, remaining_krw
        )
    ...
    def notify_emergency_stop_scalping(
        ...
        return self._enqueue_notification(
            "notify_emergency_stop_scalping",
            reason,
            total_loss,
            achievement_pct,
            remaining_krw,
